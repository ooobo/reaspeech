...
function ReaSpeechAPI:transcribe(audio_file, options)
  ...
  -- Create ProcessExecutor first to get temp file paths
  ...
  table.insert(command_parts, self:quote_path(request.output_file))
  table.insert(command_parts, "--progress-file")
  table.insert(command_parts, self:quote_path(request.progress_file))

  local command = table.concat(command_parts, " ")

  -- Set the command on the request
